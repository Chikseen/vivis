<template>
  <div class="impressum">
    ...
    <p>
      ...
      Telefon: 49-62929704<br />
      E-Mail: <a href="mailto:Tim_Menzel@t-online.de">Tim_Menzel@t-online.de</a><br />
    </p>
    <p>
      ...
      Anbieter oder Betreiber der Seiten verantwortlich. Eine permanente inhaltliche Kontrolle der verlinkten Seiten ist jedoch ohne konkrete Anhaltspunkte einer Rechtsverletzung nicht zumutbar. Bei Bekanntwerden von Rechtsverletzungen werden wir
      ...
      Die Nutzung unserer Webseite ist ohne Angabe personenbezogener Daten möglich.<br />
    ...
    <br />
    <h6>Impressum vom <a href="https://www.impressum-generator.de">Impressum Generator</a> der <a href="https://www.kanzlei-hasselbach.de/standorte/frankfurt/" rel="nofollow">Kanzlei Hasselbach, Frankfurt</a></h6>
    <h6>
      <a href="https://www.impressum-generator.de/impressum-generator/">https://www.impressum-generator.de/impressum-generator/</a>
    </h6>
  </div>
</template>
